...
/// (3) run `forge script scripts/v2-migration/Rollback.s.sol:DeployRollbackOptimism --rpc-url $ARCHIVE_NODE_URL_L2 --broadcast --verify -vvvv`
...
/// (2) load the variables in the .env file via `source .env`
/// (3) run `forge script scripts/v2-migration/Rollback.s.sol:DeployRollbackOptimismGoerli --rpc-url $ARCHIVE_NODE_URL_GOERLI_L2 --broadcast --verify -vvvv`
