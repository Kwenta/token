    ...
    UUPSUpgradeable
{
    ...
    uint32 public constant DEFAULT_DURATION = 52 weeks; // Default 1 year duration
    ...
    /// @inheritdoc IRewardEscrowV2
    function appendVestingEntry(address _account, uint128 _quantity) external onlyStakingRewards {
        // Escrow the tokens for duration.
